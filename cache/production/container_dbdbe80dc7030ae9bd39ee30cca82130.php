...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005ab361e9000000005975a72c(
...
class phpbbtemplatetwiglexer_000000005ab361e9000000005975a72c extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59f3f1222e89e725765118 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59f3f1222e8ae954531034 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59f3f1222e867095536473 = array(
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, 'set_environment', array('env' => $env), $this->initializer59f3f1222e8ae954531034);

        return $this->valueHolder59f3f1222e89e725765118->set_environment($env);
    }
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59f3f1222e8ae954531034);

        return $this->valueHolder59f3f1222e89e725765118->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59f3f1222e8ae954531034);

        return $this->valueHolder59f3f1222e89e725765118->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59f3f1222e8ae954531034 = $initializer;
    }
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, '__get', array('name' => $name), $this->initializer59f3f1222e8ae954531034);

        if (isset(self::$publicProperties59f3f1222e867095536473[$name])) {
            return $this->valueHolder59f3f1222e89e725765118->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59f3f1222e89e725765118;
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59f3f1222e8ae954531034);
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, '__isset', array('name' => $name), $this->initializer59f3f1222e8ae954531034);
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, '__unset', array('name' => $name), $this->initializer59f3f1222e8ae954531034);
    ...
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, '__clone', array(), $this->initializer59f3f1222e8ae954531034);

        $this->valueHolder59f3f1222e89e725765118 = clone $this->valueHolder59f3f1222e89e725765118;
    }

    public function __sleep()
    {
        $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, '__sleep', array(), $this->initializer59f3f1222e8ae954531034);

        return array('valueHolder59f3f1222e89e725765118');
    }
    ...
    {
        return $this->initializer59f3f1222e8ae954531034;
    }
    ...
    {
        return $this->initializer59f3f1222e8ae954531034 && $this->initializer59f3f1222e8ae954531034->__invoke($this->valueHolder59f3f1222e89e725765118, $this, 'initializeProxy', array(), $this->initializer59f3f1222e8ae954531034);
    }
    ...
    {
        return null !== $this->valueHolder59f3f1222e89e725765118;
    }
    ...
    {
        return $this->valueHolder59f3f1222e89e725765118;
    }
