...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005ddb6048000000000520b5cc(
...
class phpbbtemplatetwiglexer_000000005ddb6048000000000520b5cc extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59f3f11be666e248034937 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59f3f11be667e355316239 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59f3f11be663b341326446 = array(
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, 'set_environment', array('env' => $env), $this->initializer59f3f11be667e355316239);

        return $this->valueHolder59f3f11be666e248034937->set_environment($env);
    }
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59f3f11be667e355316239);

        return $this->valueHolder59f3f11be666e248034937->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59f3f11be667e355316239);

        return $this->valueHolder59f3f11be666e248034937->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59f3f11be667e355316239 = $initializer;
    }
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, '__get', array('name' => $name), $this->initializer59f3f11be667e355316239);

        if (isset(self::$publicProperties59f3f11be663b341326446[$name])) {
            return $this->valueHolder59f3f11be666e248034937->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59f3f11be666e248034937;
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59f3f11be667e355316239);
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, '__isset', array('name' => $name), $this->initializer59f3f11be667e355316239);
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, '__unset', array('name' => $name), $this->initializer59f3f11be667e355316239);
    ...
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, '__clone', array(), $this->initializer59f3f11be667e355316239);

        $this->valueHolder59f3f11be666e248034937 = clone $this->valueHolder59f3f11be666e248034937;
    }

    public function __sleep()
    {
        $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, '__sleep', array(), $this->initializer59f3f11be667e355316239);

        return array('valueHolder59f3f11be666e248034937');
    }
    ...
    {
        return $this->initializer59f3f11be667e355316239;
    }
    ...
    {
        return $this->initializer59f3f11be667e355316239 && $this->initializer59f3f11be667e355316239->__invoke($this->valueHolder59f3f11be666e248034937, $this, 'initializeProxy', array(), $this->initializer59f3f11be667e355316239);
    }
    ...
    {
        return null !== $this->valueHolder59f3f11be666e248034937;
    }
    ...
    {
        return $this->valueHolder59f3f11be666e248034937;
    }
